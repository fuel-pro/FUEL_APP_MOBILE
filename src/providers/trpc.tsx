...
// Use any type for the router since the actual type is defined by the backend
// The backend implements the tRPC router with proper types
// This allows the frontend to compile while the actual API types come from the backend
