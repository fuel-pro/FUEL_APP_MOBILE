      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            {filteredSales.length} sales • {formatMoney(totalSales)}
          </p>
        </div>
      </div>
            ...
            {filteredSales.length === 0 ? (
              ...
              filteredSales.map((sale) => (
                ...
                >
                  ...
                  <td className="px-4 py-4">
                    <span
                      className={`text-xs px-2 py-1 rounded-full ${sale.payment_method === "cash" ? "bg-emerald-500/20 text-emerald-400" : sale.payment_method === "mpesa" ? "bg-blue-500/20 text-blue-400" : "bg-purple-500/20 text-purple-400"}`}
                    >
                      {sale.payment_method}
                    </span>
                  </td>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="border-t border-white/10 pt-4 space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white">
                    {formatMoney(selectedSale.tax_amount)}
                  </span>
                </div>
                {selectedSale.discount_amount > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-emerald-400">
                      -{formatMoney(selectedSale.discount_amount)}
                    </span>
                  </div>
                )}
