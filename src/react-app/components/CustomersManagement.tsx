      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredCustomers.length === 0 ? (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-400">No customers</p>
          </div>
        ) : (
          filteredCustomers.map((customer) => (
            <div
              key={customer.id}
              className="bg-white/5 border border-white/10 rounded-xl p-4 cursor-pointer hover:bg-white/10"
      ...
      <div className="bg-gray-800 rounded-2xl w-full max-w-lg border border-white/10 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <p className="text-gray-500 text-center py-4">No purchases</p>
          ) : (
