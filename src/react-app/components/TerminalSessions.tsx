            ...
            {sessions.filter((s) => s.status !== "open").length === 0 ? (
              <tr>
                <td colSpan={6} className="text-center py-12">
                  ...
                  <p className="text-gray-400">No session history</p>
                </td>
              </tr>
            ) : (
              sessions
                ...
                .map((session) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${session.status === "closed" ? "bg-gray-500/20 text-gray-400" : "bg-amber-500/20 text-amber-400"}`}
                      >
                        {session.status}
                      </span>
                    </td>
